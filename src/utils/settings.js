...
export const localURL = "http://localhost:8080/security";
export const onlineURL = "https://swes.me/security"; 
...
export const postURL = "https://swes.me/security/api/post/";
 //export const avatarURL = "http://localhost:8080/security/api/avatar/";
 export const avatarURL = "https://swes.me/security/api/avatar/";
